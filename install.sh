...
#   Github - sprov-ui: https://github.com/dragonbbc/sprov-ui
#=================================================
...
install_sprov-ui() {
    ...
    wget -N --no-check-certificate -O /usr/local/sprov-ui/sprov-ui.jar https://github.com/dragonbbc/sprov-ui/releases/download/${last_version}/sprov-ui-${last_version}.jar
    if [[ $? -ne 0 ]]; then
    ...
    echo -e "wget -O /usr/bin/sprov-ui -N --no-check-certificate https://github.com/dragonbbc/sprov-ui/raw/test/sprov-ui.sh && chmod +x /usr/bin/sprov-ui"
    echo -e ""
    echo -e "若未安装 bbr 等加速工具，推荐使用以下命令一键安装 bbr："
    echo -e "wget --no-check-certificate https://github.com/dragonbbc/blog/raw/test/bbr.sh && bash bbr.sh"
    echo -e ""
}
